...
$todays_events_query = new WP_Query( $todays_events_args );
 
if($todays_events_query->have_posts() ) : ?>

	<div class="heading-block outline-dark" >
		<h1>Today's events</h1>
	</div>

    <div class="upcoming-events-overview-wrapper">

        <?php while ( $todays_events_query->have_posts() ) : $todays_events_query->the_post();?>
			...
			<div id="event-container-grid-<?php the_ID(); ?>" class="event-container-grid">
				...
				<div class="event-grid-left pad--l border-dark-all">
					...
					<a class='oxy-post-image' href='<?php the_permalink(); ?>'>
						...
						<div class='oxy-post-image-fixed-ratio-66 outline-dark' style='background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);'>
							<span role="img" aria-label="<?php echo get_post_meta( get_post_thumbnail_id(), '_wp_attachment_image_alt', true ); ?>"> </span>
						</div>

						<?php } else { ?>

						<div class='oxy-post-image-fixed-ratio-66 outline-dark' style='background-image: url("https://studio.rocketclowns.com/don/wp-content/uploads/2022/01/volksblur5.jpg");'>
				...
				<div class="event-grid-middle pad--l owl--s outline-dark">
				...
				<div class="event-grid-right pad--l outline-dark">
